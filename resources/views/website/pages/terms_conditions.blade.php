...
@section('content')
    ...
    <hero-component height="30vh" src="{{ asset('assets/heros/terms-and-conditions.jpg') }}">
        <h1>Terms & Conditions</h1>
    </hero-component>
    <div class="container my-5">
        <h2>Terms and Conditions</h2>

        <p>Welcome to pizzaservice!</p>

        <p>These terms and conditions outline the rules and regulations for the use of Pizza Service's Website, located at
            https://pizzaservice.fi.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use pizzaservice if
        ...
        <p>We employ the use of cookies. By accessing pizzaservice, you agreed to use cookies in agreement with the Pizza
        ...
        <p>Unless otherwise stated, Pizza Service and/or its licensors own the intellectual property rights for all material
            on pizzaservice. All intellectual property rights are reserved. You may access this from pizzaservice for your
            own personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from pizzaservice</li>
            <li>Sell, rent or sub-license material from pizzaservice</li>
            <li>Reproduce, duplicate or copy material from pizzaservice</li>
            <li>Redistribute content from pizzaservice</li>
        </ul>
        ...
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. Pizza Service does not filter, edit, publish or review Comments prior to their presence on
            the website. Comments do not reflect the views and opinions of Pizza Service,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted
            by applicable laws, Pizza Service shall not be liable for the Comments or for any liability, damages or expenses
            caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
            website.</p>

        <p>Pizza Service reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant Pizza Service a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Pizza
            Service; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
            must inform us by sending an e-mail to Pizza Service. Please include your name, your organization name, contact
        ...
        <p>No use of Pizza Service's logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
